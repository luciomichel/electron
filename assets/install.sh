...
wget -O centralAplicacoes.AppImage https://nexus.farmaciassaojoao.com.br/repository/static-hosted/tele-entrega/Tele-entrega-1.0.1.AppImage

# Baixando a entrada para o menu
rm -rf /opt/apps/centralAplicacoes/centralAplicacoes.desktop
wget https://nexus.farmaciassaojoao.com.br/repository/static-hosted/tele-entrega/tele.desktop

# Baixando o icone
rm -rf /opt/apps/centralAplicacoes/fsj-centralAplicacoes-desktop.png
wget https://nexus.farmaciassaojoao.com.br/repository/static-hosted/tele-entrega/fsj-tele-desktop.png

# Tornando o app image executavel
chmod a+x centralAplicacoes.AppImage
